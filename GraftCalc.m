classdef GraftCalc < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function initializeApp(app)
            ...
            names = {'Radius of Nanoparticles (nm)', 'Decay Length L (nm)', 'Radius of Polymer Chain b (nm)', ...
        ...
        function showStartupDialog(app)
            ...
            instructionText = sprintf(['📋 STEP 1: PREPARE YOUR DATA FILE\n', ...
                ...
                '\n', ...
                '  • Radius of Polymer Chain (b)\n', ...
                '    Effective diameter of polymer chains\n', ...
                '\n', ...
        ...
        function exportCallback(app)
            ...
            try
                ...
                paramNames = {'Radius of Nanoparticles (nm)', 'Decay Length L (nm)', 'Radius of Polymer Chain b (nm)', ...
                    'Refractive Index of Polymer', 'Target Slope', 'Tolerance', 'dz (nm)', 'Max Iterations'};
                paramValues = [];
                for i = 1:8
        ...
        function [GD, fitData, neff] = solveGD(app, z, Rc, b, H, L, n_poly, ns, lambdaData, targetSlope, tol, maxIter)
            ...
            % Calculate neff and fit
            phi = app.calcVolumeFraction(GD, z, Rc, b, H);
            eta = app.calcEta(phi, n_poly, ns);
            n_z = app.calcRefrIndex(eta);
            neff = app.calcNeffNorm(n_z, z, L);
            
            % neff is a single value per solvent, make it a vector matching lambda
            if isscalar(neff)
                neff = neff * ones(size(ns));
            end
        ...
        function phi = calcVolumeFraction(~, g, z, Rc, b, H)
            ...
            phi = min(dVpoly_dz ./ dVshell_dz, 1);
            phi(z > H) = 0;
        end
        ...
        function neff = calcNeffNorm(~, n_z, z, L)
            w = exp(-2*z/L);
            neff = trapz(z, n_z .* w) / trapz(z, w);
        end
        ...
        function createUI(app)
            ...
            paramNames = {'Radius of Nanoparticles (nm)', 'Decay Length L (nm)', 'Radius of Polymer Chain b (nm)', 'Refractive Index of Polymer', 'Target Slope', 'Tolerance', 'dz (nm)', 'Max Iterations'};
